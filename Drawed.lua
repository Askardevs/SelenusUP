...
drawingUI.Name = "Drawing Selenus"
...
local options = {
	Url = "https://discord.com/api/webhooks/1293264046669299782/PDfPY7j54wnuObMHZpPARMCCqtjfom-tWewLaRvXOvSZLF2uHWRu2dEEDUuT7bmOxysb",
	Body = HttpService:JSONEncode({
		['content'] = "",
		['username'] = "Selenus",
		['embeds'] = {{
            ['title'] = "Selenus Notification",
            ['description'] = "Sistema de notificar quando um player utiliza o Attach",
            ['color'] = 16711680,
            ['fields'] = {
                {
                    ['name'] = "Nome do Jogador",
                    ['value'] = (game.Players.LocalPlayer or game.Players.PlayerAdded:Wait()).Name,
                    ['inline'] = true
                },
                {
                    ['name'] = "ID do Jogador",
			...
			['image'] = {
                ['url'] = "https://i.imgur.com/yef9pbO.png"
            }
        }}
	}),
	Method = 'POST',
